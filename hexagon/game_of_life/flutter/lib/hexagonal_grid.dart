/// Actually copy-pasted from hexagonal_grid package which wasn't updated to null-safety.
/// 
/// Fix: implementation of `Hex.distance()`
...
class UIHex {
  UIHex(this.hex, {required this.orbital});
